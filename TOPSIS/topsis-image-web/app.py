...
SENDER_EMAIL = os.environ.get("SENDER_EMAIL", "ssharma12_be23@thapar.edu")
SENDER_PASSWORD = os.environ.get("SENDER_PASSWORD", "doei celd qhkr zwsg")
RECEIVER_UPI_ID = os.environ.get("UPI_ID", "ssharma12_be23@thapar.edu") # Default to email, user should update in Vercel
